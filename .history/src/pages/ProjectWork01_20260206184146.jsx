                    ...
                    <div className={styles.personaTextLeft}>
                      ...
                      <div className={styles.personaBio}>
                        ...
                        <p className={styles.personaBioText}>
                          Sarah is a 34-year-old finishing carpenter and single mom in BC, balancing a demanding trade with raising her 4-year-old son. She relies heavily on her phone to stay organized and tackle everyday challenges.
                        </p>
                      </div>
                    </div>
