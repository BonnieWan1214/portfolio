                    ...
                    <div className={styles.personaTextLeft}>
                      ...
                      <div className={styles.personaBio}>
                        ...
                        <p className={styles.personaBioText}>
                          Sarah is a 34-year-old finishing carpenter and single mom in Vancouver, balancing a demanding trade with raising her 4-year-old son. She relies on her phone to stay organized and tackle everyday challenges.
                        </p>
                      </div>
                    </div>
