...
It allows parents to find childcare easily, reducing stress and improving work-life balance
            ...
            <div className={styles.researchSection}>
              ...
              <p className={styles.overviewBody}>
                To explore users' needs and challenges, we used a mixed research approach, including one in-person interview, eight online surveys, and additional secondary research from online community discussions,the reserch focused on work schedules, childcare availability gaps, provider reliability, privacy concerns, and openness to digital solutions.
              </p>
