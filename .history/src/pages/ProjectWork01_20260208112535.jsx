              ...
              <div className={styles.evolutionList}>
                <div className={styles.evolutionItem}>
                  ...
                  <div className={styles.evolutionTextBlock}>
                    ...
                    <p className={styles.evolutionText}>The original heavy blue and green palette weighed down the experience. I brightened the tones and introduced strategic gradients to replace the static white background, adding energy and depth to the interface.</p>
                    <button
                      type="button"
